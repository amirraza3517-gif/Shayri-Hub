const database = [
    ...
    { text: "आपकी याद सताये तो दिल क्या करे ❤️<br>याद दिल से न जाये तो दिल क्या करे 🥀<br>सोचा था सपनों में मुलाक़ात होगी ✨<br>पर नींद ही न आये तो हम क्या करे!! 😴", cat: "romantic" },
    { text: "آپکی یاد ستائے تو دل کیا کرے ❤️<br>یاد دل سے نہ جائے تو دل کیا کرے 🥀<br>سوچا تھا سپنوں میں ملاقات ہوگی ✨<br>پر نیند ہی نہ آئے تو ہم کیا کرے!! 😴", cat: "romantic" }
        { text: "Kalam uthayi hai tera zikr karne ke liye,<br>Har lafz mein teri mohabbat bharne ke liye.<br>Log kehte hain ki main pagal ho gaya hoon,<br>Par main toh ji raha hoon sirf tujh par marne ke liye. ❤️✨✍️", cat: "all" },
    { text: "कलम उठाई है तेरा ज़िक्र करने के लिए,<br>हर लफ्ज़ में तेरी मोहब्बत भरने के लिए।<br>लोग कहते हैं कि मैं पागल हो गया हूँ,<br>पर मैं तो जी रहा हूँ सिर्फ़ तुझ पर मरने के लिए। ❤️✨✍️", cat: "all" },
    { text: "قلم اٹھائی ہے تیرا ذکر کرنے کے لیے،<br>ہر لفظ میں تیری محبت بھرنے کے لیے۔<br>لوگ کہتے ہیں کہ میں پاگل ہو گیا ہوں،<br>پر میں تو جی رہا ہوں صرف تجھ پر مرنے کے لیے۔ ❤️✨✍️", cat: "all" },

    { text: "Tujhse door rehna ab saza lagti hai,<br>Zindagi ki har khushi ab khafa lagti hai.<br>Kaise samjhaun is nadaan dil ko apne,<br>Ki tere bina har saans bhi ek gunah lagti hai. 💔🥀🍂", cat: "all" },
    { text: "तुझसे दूर रहना अब सज़ा लगती है,<br>ज़िन्दगी की हर खुशी अब खफ़ा लगती है।<br>कैसे समझाऊं इस नादान दिल को अपने,<br>कि तेरे बिना हर सांस भी एक गुनाह लगती है। 💔🥀🍂", cat: "all" },
    { text: "تجھ سے دور رہنا اب سزا لگتی ہے،<br>زندگی کی ہر خوشی اب خفا لگتی ہے۔<br>کیسے سمجھاؤں اس نادان دل کو اپنے،<br>کی تیرے بنا ہر سانس بھی ایک گناہ لگتی ہے۔ 💔🥀🍂", cat: "all" },

    { text: "Meri har sham tere naam ho jaye,<br>Mohabbat ka silsila yuhi aam ho jaye.<br>Main tera naam likhu kuch is tarah se,<br>Ki meri har dua tere naam se tamam ho jaye. ❤️💍✨", cat: "all" },
    { text: "मेरी हर शाम तेरे नाम हो जाये,<br>मोहब्बत का सिलसिला यूँही आम हो जाये।<br>मैं तेरा नाम लिखूँ कुछ इस तरह से,<br>कि मेरी हर दुआ तेरे नाम से तमाम हो जाये। ❤️💍✨", cat: "all" },
    { text: "میری ہر شام تیرے نام ہو جائے،<br>محبت کا سلسلہ یونہی عام ہو جائے۔<br>میں تیرا نام لکھوں کچھ اس طرح سے،<br>کہ میری ہر دعا تیرے نام سے تمام ہو جائے۔ ❤️💍✨", cat: "all" },

    { text: "Humne toh tujhe dil se chaha tha,<br>Par teri bewafayi ne humein mita diya.<br>Ab shikwa karein toh hum kis se karein,<br>Humne toh tujhe apni duniya bana liya tha. 💯🔥🚬", cat: "all" },
    { text: "हमने तो तुझे दिल से चाहा था,<br>पर तेरी बेवफाई ने हमें मिटा दिया।<br>अब शिकवा करें तो हम किस से करें,<br>हमने तो तुझे अपनी दुनिया बना लिया था। 💯🔥🚬", cat: "all" },
    { text: "ہم نے تو تجھے دل سے چاہا تھا،<br>پر تیری بے وفائی نے ہمیں مٹا دیا۔<br>اب شکوہ کریں تو ہم کس سے کریں،<br>ہم نے تو تجھے اپنی دنیا بنا لیا تھا۔ 💯🔥🚬", cat: "all" },
