const database = [
    ...
    { text: "आपकी याद सताये तो दिल क्या करे ❤️<br>याद दिल से न जाये तो दिल क्या करे 🥀<br>सोचा था सपनों में मुलाक़ात होगी ✨<br>पर नींद ही न आये तो हम क्या करे!! 😴", cat: "romantic" },
    { text: "آپکی یاد ستائے تو دل کیا کرے ❤️<br>یاد دل سے نہ جائے تو دل کیا کرے 🥀<br>سوچا تھا سپنوں میں ملاقات ہوگی ✨<br>پر نیند ہی نہ آئے تو ہم کیا کرے!! 😴", cat: "romantic" }
        { text: "Mohabbat ka imtihan har kisi se nahi hota,<br>Dil ka rishta har kisi se nahi hota.<br>Hazaaron mil jayenge chehre is duniya mein,<br>Par har kisi mein tere jaisa sukoon nahi hota. ❤️✨🧿", cat: "all" },
    { text: "मोहब्बत का इम्तिहान हर किसी से नहीं होता,<br>दिल का रिश्ता हर किसी से नहीं होता।<br>हज़ारों मिल जायेंगे चेहरे इस दुनिया में,<br>पर हर किसी में तेरे जैसा सुकून नहीं होता। ❤️✨🧿", cat: "all" },
    { text: "محبت کا امتحان ہر کسی سے نہیں ہوتا،<br>دل کا رشتہ ہر کسی سے نہیں ہوتا۔<br>ہزاروں مل جائیں گے چہرے اس دنیا میں،<br>پر ہر کسی میں تیرے جیسا سکون نہیں ہوتا۔ ❤️✨🧿", cat: "all" },

    { text: "Tere bina zindagi mein koi raunak nahi rahi,<br>Har khushi ab mujhe meri dushman lagti hai.<br>Kaise batayein ki kis qadar chaha hai tujhe,<br>Ab toh har saans bhi tere naam ki amanat lagti hai. 💔🍂🥀", cat: "all" },
    { text: "तेरे बिना ज़िन्दगी में कोई रौनक नहीं रही,<br>हर खुशी अब मुझे मेरी दुश्मन लगती है।<br>कैसे बताएं कि किस कदर चाहा है तुझे,<br>अब तो हर सांस भी तेरे नाम की अमानत लगती है। 💔🍂🥀", cat: "all" },
    { text: "تیرے بنا زندگی میں کوئی رونق نہیں رہی،<br>ہر خوشی اب مجھے میری دشمن لگتی ہے۔<br>کیسے بتائیں کہ کس قدر چاہا ہے تجھے،<br>اب تو ہر سانس بھی تیرے نام کی امانت لگتی ہے۔ 💔🍂🥀", cat: "all" },

    { text: "Wafaon ki baatein ab humse na kijiye,<br>Humne toh apna sab kuch tujh par waar diya.<br>Khuda se manga tha tujhe har dua mein humne,<br>Par tune toh ek pal mein humein paraya kar diya. 🔥📜💯", cat: "all" },
    { text: "वफ़ाओं की बातें अब हमसे ना कीजिये,<br>हमने तो अपना सब कुछ तुझ पर वार दिया।<br>खुदा से मांगा था तुझे हर दुआ में हमने,<br>पर तूने तो एक पल में हमें पराया कर दिया। 🔥📜💯", cat: "all" },
    { text: "وفاؤں کی باتیں اب ہم سے نہ کیجیے،<br>ہم نے تو اپنا سب کچھ تجھ پر وار دیا۔<br>خدا سے مانگا تھا تجھے ہر دعا میں ہم نے،<br>پر تو نے تو ایک پل میں ہمیں پرایا کر دیا۔ 🔥📜💯", cat: "all" },

    { text: "Teri yaad aati hai toh aankhein bhar aati hain,<br>Zindagi ki raahein ab suni nazar aati hain.<br>Pehle toh har pal tere saath bitana tha humein,<br>Ab toh teri har baat humein sirf rulati hai. ✨🚶‍♂️💔", cat: "all" },
    { text: "तेरी याद आती है तो आँखें भर आती हैं,<br>ज़िन्दगी की राहें अब सूनी नज़र आती हैं।<br>पहले तो हर पल तेरे साथ बिताना था हमें,<br>अब तो तेरी हर बात हमें सिर्फ रुलाती है। ✨🚶‍♂️💔", cat: "all" },
    { text: "تیری یاد آتی ہے تو آنکھیں بھر آتی ہیں،<br>زندگی کی راہیں اب سونی نظر آتی ہیں۔<br>پہلے تو ہر پل تیرے ساتھ بتانا تھا ہمیں،<br>اب تو تیری ہر بات ہمیں صرف رلاتی ہے۔ ✨🚶‍♂️💔", cat: "all" }
